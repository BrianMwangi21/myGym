...
import static iamprogrammer.brian.com.mygym.AppConfig.GEOMETRY;
import static iamprogrammer.brian.com.mygym.AppConfig.GOOGLE_BROWSER_API_KEY;
import static iamprogrammer.brian.com.mygym.AppConfig.LATITUDE;
import static iamprogrammer.brian.com.mygym.AppConfig.LOCATION;
import static iamprogrammer.brian.com.mygym.AppConfig.LONGITUDE;
import static iamprogrammer.brian.com.mygym.AppConfig.NAME;
import static iamprogrammer.brian.com.mygym.AppConfig.OK;
import static iamprogrammer.brian.com.mygym.AppConfig.PROXIMITY_RADIUS;
import static iamprogrammer.brian.com.mygym.AppConfig.RESULTS;
import static iamprogrammer.brian.com.mygym.AppConfig.STATUS;
import static iamprogrammer.brian.com.mygym.AppConfig.VICINITY;
import static iamprogrammer.brian.com.mygym.AppConfig.ZERO_RESULTS;
...
public class GymsActivity extends AppCompatActivity implements OnMapReadyCallback  {
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, googlePlacesUrl.toString(), null,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(GymsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
        );
        queue.add(request);
    ...
    public void parseLocationResult(JSONObject result) {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(GymsActivity.this, e.getMessage(), Toast.LENGTH_LONG).show();
        }
    }
